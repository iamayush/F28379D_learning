...
#define SINC_FILTER_MAX_OSR 256  //Max OSR for Sinc filter
#define INTEGRATOR_MAX_OSR 128   //Max OSR for integrator


//*****************************************************************************
// Different Input Control modes
// These values can be passed as argument to Configure_SDFM_Input_Control function
//*****************************************************************************
...
//
// (1) Configure_SDFM_Input_Control()
// (2) Configure_SDFM_Comparator()
// (3) Configure_SDFM_Sinc_filter()
// (4) Configure_SDFM_Integrator()
// (5) Enable_SDFM_interrupt()
//*****************************************************************************
#define FILTER1			0x01   //Used to select filter1 for either comparator, Sinc filter (or) integrator module
#define FILTER2			0x02   //Used to select filter2 for either comparator, Sinc filter (or) integrator module
#define FILTER3			0x04   //Used to select filter3 for either comparator, Sinc filter (or) integrator module
#define FILTER4			0x08   //Used to select filter4 for either comparator, Sinc filter (or) integrator module


//*****************************************************************************
// The following are values that can be passed to Configure_SDFM_Sinc_filter()
//*****************************************************************************
...
// The following are values that can be passed to following functions
//
// (1) Configure_SDFM_Comparator()
// (2) Configure_SDFM_Sinc_filter()
// (3) Configure_SDFM_Integrator()
//*****************************************************************************
#define SINCFAST		0x00   //Used to select Sincfast filter type for either comparator, Sinc filter (or) integrator module
#define SINC1			0x01   //Used to select Sinc1 filter type for either comparator, Sinc filter (or) integrator module
#define SINC2			0x02   //Used to select Sinc2 filter type for either comparator, Sinc filter (or) integrator module
#define SINC3			0x03   //Used to select Sinc3 filter type for either comparator, Sinc filter (or) integrator module


//*****************************************************************************
// Enable / Disable High-level threshold interrupt for Comparator filter output
// These values can be passed as argument to Enable_SDFM_interrupt()
//*****************************************************************************
...
// This value can be passed to SDFM_configureIntegrator()
//*****************************************************************************
...
//*****************************************************************************
// Enable / Disable Integrator module
// This value can be passed to SDFM_configureIntegrator()
//*****************************************************************************
#define INTEGRATOR_DISABLE  0
#define INTEGRATOR_ENABLE   1

//*****************************************************************************
// Enable / Disable Demodulator module
// This value can be passed to SDFM_configureIntegrator()
//*****************************************************************************
#define DEMODULATION_DISABLE 	0
#define DEMODULATION_ENABLE		1

//*****************************************************************************
// Can be used to read SDIFLG register
//*****************************************************************************
#define READ_SDIFLG(x) (*SDFM[x]).SDIFLG.all

//*****************************************************************************
// Can be used to clear SDIFLG register
//*****************************************************************************
#define CLEAR_SDIFLG(x,y) (*SDFM[x]).SDIFLGCLR.all = y
...
extern void Sdfm_configureSinc_filter(Uint16 SDFM_number, Uint16 Filter_number, Uint16 Filter_switch, Uint16 Filter_type, Uint16 OSR);
extern void Sdfm_configureIntegrator(Uint16 SDFM_number, Uint16 Filter_number, Uint16 Filter_type, Uint16 OSR,Uint16 INTG_switch, Uint16 DR_switch,Uint16 shift_bits ,Uint16 DEN_switch);
