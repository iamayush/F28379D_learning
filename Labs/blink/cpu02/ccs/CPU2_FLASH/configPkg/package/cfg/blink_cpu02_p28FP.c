...
/* --> clkfunc */
extern xdc_Void clkfunc(xdc_UArg);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Dan/F28377/AddSYSBIOStoCexamples/blink/cpu02/ccs/CPU2_FLASH/configPkg/package/cfg/blink_cpu02_p28FP");
...
ti_sysbios_knl_Clock_Object__ ti_sysbios_knl_Clock_Object__table__V[1] = {
    {/* instance#0 */
        ...
        (xdc_UInt32)0xfa,  /* timeout */
        (xdc_UInt32)0xfa,  /* currTimeout */
        (xdc_UInt32)0xfa,  /* period */
        1,  /* active */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)clkfunc)),  /* fxn */
        ((xdc_UArg)0),  /* arg */
    },
};
